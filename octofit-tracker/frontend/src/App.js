  ...
  return (
    <Router>
      <div className="container mt-4">
        <nav className="navbar navbar-expand-lg navbar-dark bg-primary rounded mb-4">
          <div className="container-fluid">
            <Link className="navbar-brand d-flex align-items-center fw-bold" to="/">
              <img src={logo} alt="Octofit Logo" className="octofit-logo me-2" style={{height: '40px', width: '40px', objectFit: 'contain'}} />
              Octofit Tracker
            </Link>
        ...
        <h1 className="mb-4 display-4 text-center">Octofit Tracker</h1>
        <Routes>
